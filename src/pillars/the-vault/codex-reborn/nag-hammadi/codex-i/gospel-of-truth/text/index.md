...
<details class="disclaimer-box">
  ...
  <p>
    Translation © <strong>Robert M. Grant</strong>.  
    Originally published in <em>Robert M. Grant, <q>Gnosticism</q></em>  
    (<strong>Harper & Brothers</strong>, New York, 1961),  
    and reprinted in <em>Willis Barnstone (ed.), <q>The Other Bible</q></em>  
    (<strong>Harper & Row</strong>, San Francisco, 1984).
  </p>

  <p>
    This presentation is adapted and formatted for  
    <em>The Gnostic Society Library</em> and  
  ...
  <p>
    Original source:  
    <a href="https://www.gnosis.org/naghamm/got.html" target="_blank" rel="noopener noreferrer">
      gnosis.org – The Gospel of Truth
    </a>
  </p>
</details>

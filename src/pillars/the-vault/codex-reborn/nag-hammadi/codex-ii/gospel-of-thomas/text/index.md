...
{% block bookmark %}{% include "partials/bookmark.njk" %}{% endblock %}
  ...
  <details class="disclaimer-box">
    ...
    <p>This text was discovered at <strong>Nag Hammadi</strong> in 1945, buried in the Egyptian desert. It contains 114 logia &mdash; &ldquo;sayings&rdquo; &mdash; attributed to <strong>Yeshua</strong> the Living One. There is no crucifixion, no resurrection &mdash; only the Word. What follows is a raw mirror of gnosis, rendered in sacred formatting for the digital temple of <strong>The Gnostic Key.</strong></p>
  </details>
...
<details class="disclaimer-box">
  ...
  <p>
    Translation © <strong>1992, 1994 Stephen Patterson</strong> and <strong>Marvin Meyer</strong>.  
    Published in <em>Robert J. Miller (ed.), <q>The Complete Gospels: Annotated Scholars Version</q></em>,  
    <strong>Polebridge Press</strong>.
  </p>

  <p>
    This selection is presented through <em>The Gnostic Society Library</em> and  
  ...
  <p>
    Original source:  
    <a href="https://www.gnosis.org/naghamm/gthlamb.html" target="_blank" rel="noopener noreferrer">
      gnosis.org – The Gospel of Thomas (Selections from The Complete Gospels)
    </a>
  </p>

export default {
  ...
  // === Core Identity ===
  pageId: "the-vault-codex-reborn-nag-hammadi-codex-ii-hypostasis-of-the-archons",
  permalink:
    "/pillars/the-vault/codex-reborn/nag-hammadi/codex-ii/hypostasis-of-the-archons/index.html",
  ...
  tagline: "The Reality of the Rulers ✦ Sophia’s Intervention ✦ The Birth of the True Human",
  ...
  // === Local Series Navigation (Codex II Index Links Only) ===
  seriesNav: [
    {
    ...
    },
    {
      ...
      desc: "Sayings of the Living Jesus revealing the hidden knowledge of inner sight and remembrance.",
      url: "/pillars/the-vault/codex-reborn/nag-hammadi/codex-ii/gospel-of-thomas/"
    },
    {
      title: "Gospel of Philip",
      desc: "Teachings on unity, illusion, and the bridal chamber — unveiling the mystical sacrament of spiritual union.",
  ...
  synergistLens: {
    crossLinks: [
      ...
      {
        title: "SYSTEMIC – Scroll II: Forensic Fictions",
        path: "/pillars/the-obsidian-key/systemic/forensic-fictions/",
        desc: "Examines the ancient Archons as prototypes of modern rulers of perception and justice — the same machinery of control in a new guise."
      }
    ]
  },
  ...
  // === Social Meta ===
  socialImage: "/tgk-assets/images/share/the-vault/hypostasis-of-the-archons.jpg",

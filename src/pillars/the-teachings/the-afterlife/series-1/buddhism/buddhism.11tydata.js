export default {
  ...
  episodeParts: [
    { title: "Part I — TBD", desc: "", url: "/pillars/the-teachings/the-afterlife/series-1/buddhism/part-1/" },
    { title: "Part II — TBD", desc: "", url: "/pillars/the-teachings/the-afterlife/series-1/buddhism/part-2/" },
    { title: "Part III — TBD", desc: "", url: "/pillars/the-teachings/the-afterlife/series-1/buddhism/part-3/" }
  ],
  layout: "base.njk",
  ...
  eleventyComputed: {
    ...
    imgBase: (d) => d.imgBase || "/media/the-teachings/the-afterlife/series-1/buddhism",
    imgPrefix: (d) => d.imgPrefix || "buddhism-",
    socialImage: (d) => d.socialImage || "/tgk-assets/images/share/the-teachings/the-afterlife/buddhism.jpg",
    breadcrumbsBase: (d) => [

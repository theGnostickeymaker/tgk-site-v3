export default {
  ...
  episodeParts: [
    { title: "Part I — TBD", desc: "", url: "/pillars/the-teachings/the-afterlife/series-1/kabbalah/part-1/" },
    { title: "Part II — TBD", desc: "", url: "/pillars/the-teachings/the-afterlife/series-1/kabbalah/part-2/" },
    { title: "Part III — TBD", desc: "", url: "/pillars/the-teachings/the-afterlife/series-1/kabbalah/part-3/" }
  ],
  layout: "base.njk",
  ...
  eleventyComputed: {
    ...
    imgBase: (d) => d.imgBase || "/media/the-teachings/the-afterlife/series-1/kabbalah",
    imgPrefix: (d) => d.imgPrefix || "kabbalah-",
    socialImage: (d) => d.socialImage || "/tgk-assets/images/share/the-teachings/the-afterlife/kabbalah.jpg",
    breadcrumbsBase: (d) => [

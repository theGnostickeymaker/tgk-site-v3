export default {
  ...
  pageId: "the-teachings-the-afterlife-series-1",
  permalink: "/pillars/the-teachings/the-afterlife/series-1/index.html",
  ...
  introText:
    "Choose an episode — each path reveals a different face of the afterlife.",
  ...
  pillarGrid: [
    ...
    },
    {
      ...
      glyph: "✡",
      tagline:
        "The Tree of Life ✦ the soul’s descent ✦ the light of restoration.",
      tier: "free",
      state: "active"
    },
    {
    ...
    },
    {
      ...
      glyph: "🌽",
      tagline:
        "Three-part journey through the false cosmos and the Revealer.",
      tier: "initiate",
      state: "active"
    }
  ],
  ...
  // === Social Meta ===
  socialImage:
    "/tgk-assets/images/share/the-teachings/the-afterlife-series1.jpg",

...
creativePrompt:
  ...
  text: "Write a poem or sketch a scene imagining your own passage through the bardo. What visions arise, deities, fears, or light? What calls you towards nirvāṇa?"
...
glossary:
  ...
  terms:
    - term: "Vajrayāna"
      def: "The Diamond Vehicle, a swift esoteric path using ritual, deity yoga, mantra, and skilful means."
    - term: "Yidam"
      def: "A personal meditation deity embodying enlightened qualities, the focal point of Vajrayāna visualisation."
    - term: "Bardo"
      def: "The intermediate state between death and rebirth."
    - term: "Skilful Means (Upaya)"
      def: "Compassionate methods adapted to each being’s needs."
    - term: "Clear Light"
      def: "The radiant nature of mind revealed at death or in deep meditation."

# References
references:
  title: "Sources and Study Path"
  intro: "Sources for deeper exploration of the Diamond Vehicle and Bardo teachings."
  readings:
    - title: "The Tibetan Book of the Dead (Bardo Thödol)"
      desc: "Guide to the after-death states and the Clear Light."
    - title: "The Tibetan Book of Living and Dying, Sogyal Rinpoche"
      desc: "A modern synthesis of Bardo teachings and contemporary insight."
    - title: "The Crystal and the Way of Light, Chögyal Namkhai Norbu"
      desc: "Introduction to Dzogchen and the direct recognition of awareness."
    - title: "Introduction to Tantra, Lama Yeshe"
      desc: "Accessible overview of Vajrayāna practice and deity yoga."
    - title: "The Heart Sutra and Prajñāpāramitā Teachings"
      desc: "Core Mahāyāna scriptures on emptiness that underpin the Diamond Path."
  scholarly:
    ...
    - author: "Dalai Lama XIV"
      year: "2002"
      work: "Advice on Dying and Living a Better Life"
      pub: "Atria Books"
...
episodeParts:
  ...
  - title: "Part III — The Diamond Path"
    desc: "Through the bardos, the Clear Light, and liberation beyond rebirth."
...
seriesNav:
  ...
  - title: "Kabbalah"
    desc: "The ascent through the Tree of Life and the return to harmony."
  ...
  - title: "Ancient Egypt"
    desc: "The Hall of Ma’at and the soul’s judgement."
    url: "/pillars/the-teachings/the-afterlife/series-1/ancient-egypt/"
  - title: "Mesoamerica"
    desc: "The nine levels of the underworld and the trials of rebirth."
...
<details class="disclaimer-box">
  ...
  <p>From Samsāra&rsquo;s wheel to the bodhisattva&rsquo;s return, you&rsquo;ve danced through birth, death, and intention. Now the Diamond Path opens, the Vajra blade cuts illusion, and the radiant void calls the soul home.</p>
</details>
...
<section class="section-block">
  ...
  <p>These states are not just afterlife events. They mirror the processes of mind happening every moment: death of one thought, space, arising of the next.</p>
